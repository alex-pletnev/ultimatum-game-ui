          ...
          {availableNpcs.length > 0 && (
            <>
              ...
              <button
                ...
                className="rounded-panel border border-ember-600/40 bg-ember-500 press-tactile min-h-11 px-4 py-2 font-display text-sm uppercase tracking-[0.2em] text-night-950 sm:tracking-[0.24em] shadow-[0_4px_0_var(--color-ember-700)] transition hover:translate-y-[-1px] disabled:cursor-not-allowed disabled:opacity-50"
              >
